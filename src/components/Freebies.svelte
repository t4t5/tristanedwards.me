...
<div class="bg">
  ...
  <FreebieCard href="https://ether.se" color="rgba(144,60,242,0.06)">
    <Ether width="161" height="55" />
  </FreebieCard>

  <FreebieCard
    href="https://ember-sparks.github.io"
    color="rgba(242,144,60,0.06)">
    <EmberSparks width="245" height="31" />
  </FreebieCard>
</div>
